...
export class TestimonialComponent {
  tdata1 = "Sanjukta has a phenomenal gift and this coupled with her caring personality and sense of humour makes readings both real and meaningful.She gets it so right and can often advise what actions to take by laying cards on top for more specific questions.Last week, Sanjukta was able to add on an extra service with her pendulum and fine tune on a reading.I have seen Sanjukta for personal readings but also in corporate situations,she really can work the crowd with her quick wit and her guides always seem to be there helping to pass on message to the guest.";
  tdata2 = "I had the best experience having read from her. She is very intuitive and spot on about the traits of a person. She was very kind and patient with my reading and spoke to me as a friend. I will keep updating this platform as and when the time comes but I have a lot of faith in what she has said and am positive of all of it coming true.";
  tdata3 = "Very impressive and close to accurate reading by Sanjukta for me and family.Has helped in some of my very important decision for self and dear ones.Highly recommended from my end to take her help as her hard work and dedication is surely helping lot of us for a smooth ride of our lives.";
  tdata4 = "Have done a few readings.. Uncanny and and unreal sessions which replicate the inner thought process. Very precise.Very grateful to have found a reader like her. 🙏🏼.";
