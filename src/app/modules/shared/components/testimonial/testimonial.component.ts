...
export class TestimonialComponent {
  tdata1 = "Meeting Sanjukta felt like fate, arriving at a time when I was battling personal, career, and financial struggles that had begun to weigh heavily on my family life. By chance, we crossed paths at a friend’s gathering during her visit to the UK, and from that moment, my life began to transform. Our first Akashic Records and tarot reading session revealed insights that felt both magical and deeply grounding. Sanjukta's extraordinary ability to connect with my energy and guide me through the chaos I was experiencing helped me take steps I had never imagined. Her wisdom and intuitive gifts not only shifted my perspective but also gave me the clarity and courage to make choices that changed the course of my life";
